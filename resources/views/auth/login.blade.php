...
<head>
    ...
    <title>Login &mdash; CV Restu Ibu</title>
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h5 class="text-dark font-weight-normal">Aplikasi <span class="font-weight-bold">Inventaris Barang</span></h5>
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; Inven-BS. Made with 💙 by Meiko
                        </div>
                    </div>
                </div>
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                ...
                                <h5 class="font-weight-normal text-muted-transparent">Cianjur, Indonesia</h5>
                            </div>
                            Photo by <a class="text-light bb" target="_blank" href="https://www.instagram.com/kknmum.umy005/">KP.Unsur</a>
                        </div>
                    </div>
                </div>
            </div>
